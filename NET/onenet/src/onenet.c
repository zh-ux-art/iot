...
void OneNet_RevPro(unsigned char *cmd)
{
	...
	if(dataPtr != NULL)					//如果找到了
	{
		...
		if(strstr((char *)req_payload, "mode_flag"))		//搜索"mode_flag"
		{
		...
		else if(strstr((char *)req_payload, "led_flag"))		//搜索"shengbeng_flag"
		{
		...
		else if(strstr((char *)req_payload, "fs_flag"))		//搜索"shengbeng_flag"
		{
			if(upload_data.mode_flag==1)
			{
				if(num == 1)								//控制数据如果为1，代表开
		...
		else if(strstr((char *)req_payload, "jr_flag"))		//搜索"shengbeng_flag"
		{
			if(upload_data.mode_flag==1)
			{
				if(num == 1)								//控制数据如果为1，代表开
		...
		else if(strstr((char *)req_payload, "templ"))		//搜索"shengbeng_flag"
		{
			upload_data.temp_l=num;
		}
		else if(strstr((char *)req_payload, "temph"))		//搜索"shengbeng_flag"
		{
			upload_data.temp_h=num;
		}
		
		else if(strstr((char *)req_payload, "humi"))		//搜索"shengbeng_flag"
		{
			upload_data.humi_y=num;
		}
		else if(strstr((char *)req_payload, "lsens"))		//搜索"shengbeng_flag"
		{
			upload_data.lsens_y=num;
		}
		else if(strstr((char *)req_payload, "mq2"))		//搜索"shengbeng_flag"
		{
